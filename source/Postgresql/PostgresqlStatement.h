...
namespace Postgresql
{
	...
	/// PostgresqlStatement
	//-------------------------------------------------------------------------------------------------
	class PostgresqlStatement : public NonCopyable
	{
	private:
	...
	public:
		...
		//---------------------------------------------------------------------------------------------
		inline PostgresqlStatement(PostgresqlStatement&& postgresqlStatement) :
			m_name(postgresqlStatement.m_name),
			m_connection(postgresqlStatement.m_connection),
			m_result(postgresqlStatement.m_result)
		{
		}
...
*/
		...
		//---------------------------------------------------------------------------------------------
		inline void operator =(PostgresqlStatement&& postgresqlStatement)
		{
			m_name = postgresqlStatement.m_name;
			m_connection = postgresqlStatement.m_connection;
			m_result = postgresqlStatement.m_result;

			postgresqlStatement.m_result = nullptr;
		}
	...
	private:
		//---------------------------------------------------------------------------------------------
		__forceinline PostgresqlStatement(const char* name, PGconn* connection) : m_name(name), m_connection(connection), m_result(nullptr)
		{
		}
		...
		{
		public:
			__forceinline static void Extract(PostgresqlStatement& postgresqlStatement, int32_t tupleIndex, int32_t resultIndex, Result& resultValue) = delete;
		};
		...
		{
		public:
			__forceinline static void Extract(PostgresqlStatement& postgresqlStatement, int32_t tupleIndex, int32_t resultIndex, Result& resultValue)
			{
				postgresqlStatement.ExtractResult(tupleIndex, resultIndex, reinterpret_cast<typename std::underlying_type<Result>::type&>(resultValue));
			}
		};
	};
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<int16_t>(int32_t tupleIndex, int32_t resultIndex, int16_t& resultValue)
	{
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<int32_t>(int32_t tupleIndex, int32_t resultIndex, int32_t& resultValue)
	{
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<int64_t>(int32_t tupleIndex, int32_t resultIndex, int64_t& resultValue)
	{
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<uint16_t>(int32_t tupleIndex, int32_t resultIndex, uint16_t& resultValue)
	{
		assert(PQgetlength(m_result, tupleIndex, resultIndex) == sizeof(int16_t));
		assert(PQftype(m_result, resultIndex) == INT2OID);
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<uint32_t>(int32_t tupleIndex, int32_t resultIndex, uint32_t& resultValue)
	{
		assert(PQgetlength(m_result, tupleIndex, resultIndex) == sizeof(int32_t));
		assert(PQftype(m_result, resultIndex) == INT4OID);
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<uint64_t>(int32_t tupleIndex, int32_t resultIndex, uint64_t& resultValue)
	{
		assert(PQgetlength(m_result, tupleIndex, resultIndex) == sizeof(int64_t));
		assert(PQftype(m_result, resultIndex) == INT8OID);
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<bool>(int32_t tupleIndex, int32_t resultIndex, bool& resultValue)
	{
		assert(false);
	}
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<float>(int32_t tupleIndex, int32_t resultIndex, float& resultValue)
	{
		assert(false);
	}
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<double>(int32_t tupleIndex, int32_t resultIndex, double& resultValue)
	{
		assert(false);
	}
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<std::string>(int32_t tupleIndex, int32_t resultIndex, std::string& resultValue)
	{
	...
	//-------------------------------------------------------------------------------------------------
	template <>
	__forceinline void PostgresqlStatement::ExtractResult<std::vector<byte>>(int32_t tupleIndex, int32_t resultIndex, std::vector<byte>& resultValue)
	{
