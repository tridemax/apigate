...
#pragma pack(push, 4)
		...
		public:
			...
			__forceinline PostgresqlArgument(const Argument& argumentValue)
			{
			...
			__forceinline PostgresqlArgument(const char* const& argumentValue)
			{
...
#pragma pack(pop)
		...
		typedef std::vector<PostgresqlArgument> ArgumentVector;
